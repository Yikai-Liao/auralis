...
use auralis_wav::{
    ...
    decode_pcm16_path, decode_pcm16_with_backend, decode_pcm24, decode_pcm24_path, decode_wav,
};

mod support;

use support::{
    assert_audio_bits_eq, riff_header, wav_bytes, wav_bytes_pcm8, wav_bytes_pcm24,
