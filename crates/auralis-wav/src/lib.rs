...
//!
//! This crate currently implements deterministic PCM8, PCM16, and PCM24 WAV
...
pub use reader::{
    ...
    decode_pcm24_with_backend, decode_wav, decode_wav_path, decode_wav_path_with_backend,
    decode_wav_with_backend,
};
pub use writer::{
    Pcm8WavEncoder, Pcm8WavWriter, Pcm16WavEncoder, Pcm16WavWriter, Pcm24WavEncoder,
    Pcm24WavWriter, encode_pcm8, encode_pcm8_path, encode_pcm8_path_with_backend,
    encode_pcm8_with_backend, encode_pcm16, encode_pcm16_path, encode_pcm16_path_with_backend,
    encode_pcm16_with_backend, encode_pcm24, encode_pcm24_path, encode_pcm24_path_with_backend,
    encode_pcm24_with_backend,
};
