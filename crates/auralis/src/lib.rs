...
pub use auralis_effects::{
    ...
    EffectDescriptor, EffectKind, EffectNameError, EffectRegistry, EffectsFileParseError,
    EffectsFileReadError, SUPPORTED_EFFECTS, parse_effect_chain, parse_effects_file,
