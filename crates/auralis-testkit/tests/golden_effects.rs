...
fn effects_golden_manifest_records_standalone_effect_cases() {
    ...
    assert_eq!(
        ...
        [
            ...
            "effect_bend_mono_zero_duration",
            "effect_bend_stereo_custom_options",
            ...
            "effect_fir_mono_inline",
            "effect_fir_stereo_inline",
            "effect_firfit_mono_flat",
            "effect_firfit_stereo_flat",
            ...
            "effect_splice_mono_quarter_sine",
            "effect_splice_stereo_half_sine",
            "effect_stat_mono_pass_through",
            "effect_stat_stereo_pass_through",
            "effect_stats_mono_pass_through",
            "effect_stats_stereo_pass_through",
            "effect_stretch_mono_lengthen",
            "effect_stretch_stereo_shorten",
            "effect_swap_mono_identity",
            "effect_swap_stereo",
            "effect_synth_mono_linear_sweep",
            "effect_synth_mono_mix",
            "effect_synth_mono_sine",
            "effect_synth_mono_whitenoise",
            "effect_synth_stereo_sine_square",
            ...
            "effect_vad_mono_silence_trim",
            "effect_vad_stereo_silence_trim",
