...
`rate 44100` or `rate 44.1k`, performs deterministic scalar linear resampling,
and rejects SoX-ng quality and override options until the follow-up `rate`
features add those modes.
