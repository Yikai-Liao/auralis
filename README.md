...
Initial scope is deliberately narrow: **linear PCM WAV first**, with PCM8,
PCM16, PCM24, and PCM32 currently implemented. Additional formats are planned only after effect
...
- a Rust workspace with `auralis`, `auralis-core`, `auralis-wav`,
  ...
  `auralis-cli` crates;
- PCM8/PCM16/PCM24/PCM32 WAV decode plus PCM16 legacy output and PCM8/PCM16/PCM24/PCM32
  output through the newer `OutputFormat::Wav(WavEncodeOptions)` boundary, alongside
  `auralis inspect`;
