...
PCM32, float32, float64, u-law, and A-law currently implemented. Additional formats are
...
- a Rust workspace with `auralis`, `auralis-core`, `auralis-wav`,
  ...
  `auralis-cli` crates;
- PCM8/PCM16/PCM24/PCM32/float32/float64/u-law/A-law WAV decode plus PCM16 legacy output and
  PCM8/PCM16/PCM24/PCM32/float32/float64/u-law/A-law output through the newer
