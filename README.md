...
PCM16, and PCM24 currently implemented. Additional formats are planned only after effect
...
- a Rust workspace with `auralis`, `auralis-core`, `auralis-wav`,
  ...
  `auralis-cli` crates;
- PCM8/PCM16/PCM24 WAV decode plus PCM16 legacy output and PCM8/PCM16/PCM24
